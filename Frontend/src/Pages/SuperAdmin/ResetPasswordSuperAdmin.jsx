    ...
    return (
      <div className={bgClasses} style={bgStyle}>
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-red-50 rounded-full blur-[100px] animate-pulse" />
        ...
        <motion.div initial={{ opacity: 0, y: 30, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }} className="relative w-full max-w-[420px]">
          ...
          <div className="relative backdrop-blur-xl bg-slate-100 border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="p-8 sm:p-10 text-center">
              <div className="mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br from-red-500/20 to-rose-600/20 border border-slate-200 flex items-center justify-center mb-5 shadow-lg shadow-red-500/10">
              ...
              <h1 className="text-xl font-bold text-slate-900 mb-2">Enlace inválido o expirado</h1>
              <p className="text-sm text-slate-500 mb-8 leading-relaxed">
                Este enlace de restablecimiento ya no es válido.<br />Solicita uno nuevo desde la pantalla de login.
              </p>
              <button onClick={onBack}
                className="w-full py-3 px-4 rounded-xl font-medium text-sm bg-gradient-to-r from-red-500/80 to-rose-600/80 text-slate-900 hover:from-red-400 hover:to-rose-500 shadow-lg shadow-red-500/20 transition-all duration-300 active:scale-[0.98]"
              >
                Volver al login
              </button>
            </div>
          </div>
          <p className="text-center mt-6 text-xs text-slate-500">MenuBy — Panel de Administración</p>
        </motion.div>
      </div>
    );
  }
        ...
        <div className="relative backdrop-blur-xl bg-slate-100 border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 sm:p-10">
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.5 }} className="text-center mb-8">
              ...
              <p className="mt-1.5 text-sm text-slate-500">Ingresa tu nueva contraseña</p>
            </motion.div>
