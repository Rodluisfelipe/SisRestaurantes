      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-4 border-b border-slate-100">
          <div className="w-9 h-9 rounded-xl bg-amber-100 flex items-center justify-center flex-shrink-0">
            <svg className="w-4.5 h-4.5 text-amber-600" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z" />
            </svg>
          </div>
          <div className="flex-1 min-w-0">
            <h3 className="text-[14px] font-bold text-slate-900">Resetear credenciales</h3>
            <p className="text-[11px] text-slate-400 truncate">{business.businessName}</p>
          </div>
          <button onClick={onClose} className="w-7 h-7 rounded-lg bg-slate-100 flex items-center justify-center text-slate-400 hover:text-slate-600 transition-colors">
          ...
          {loading ? (
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 p-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                ...
                <p className="text-[13px] font-semibold text-emerald-700">Credenciales actualizadas</p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mb-1.5 px-3 py-2 rounded-lg bg-slate-50 border border-slate-200 text-[11px] text-slate-400">
                  Actual: <span className="font-mono text-slate-600">{currentUsername}</span>
                </div>
                <input
                  type="email"
                  value={newUsername}
                  ...
                  className="w-full px-3 py-2.5 rounded-xl bg-white border border-slate-200 text-sm text-slate-900 placeholder-slate-300 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400/20 transition-all"
                />
              </div>
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    <input
                      ...
                      className="w-full px-3 py-2.5 pr-10 rounded-xl bg-white border border-slate-200 text-sm text-slate-900 placeholder-slate-300 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400/20 transition-all font-mono"
                    />
                    <button
                      type="button"
                  ...
                  <button
                    ...
                    className="px-3 py-2.5 rounded-xl bg-slate-100 text-[12px] font-semibold text-slate-600 hover:bg-slate-200 transition-colors whitespace-nowrap border border-slate-200"
                  >
                    Generar
                  </button>
                </div>
              ...
              <div className="flex gap-2 pt-1">
                <button onClick={onClose} className="flex-1 py-2.5 rounded-xl bg-slate-100 text-slate-600 text-[13px] font-semibold hover:bg-slate-200 transition-colors">
                  Cancelar
                </button>
                <button
                  onClick={handleSave}
...
export default function BusinessTable({ refreshTrigger }) {
    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        {[
          ...
          { label: 'Inactivos', value: stats.inactive, color: 'text-amber-600' },
        ].map((stat, i) => (
          <motion.div
            key={stat.label}
          ...
          >
            ...
            <p className={`text-2xl font-semibold mt-1 tabular-nums ${stat.color || 'text-slate-900'}`}>{stat.value}</p>
          </motion.div>
        ))}
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-5">
        <div className="relative flex-1">
          <svg className="w-4 h-4 absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200">
                <th className="text-left py-3 px-4 text-xs font-medium text-slate-500 uppercase tracking-wider">Negocio</th>
                <th className="text-left py-3 px-4 text-xs font-medium text-slate-500 uppercase tracking-wider">Slug</th>
                <th className="text-left py-3 px-4 text-xs font-medium text-slate-500 uppercase tracking-wider">WhatsApp</th>
                <th className="text-left py-3 px-4 text-xs font-medium text-slate-500 uppercase tracking-wider">Estado</th>
                <th className="text-left py-3 px-4 text-xs font-medium text-slate-500 uppercase tracking-wider">POS</th>
                <th className="text-left py-3 px-4 text-xs font-medium text-slate-500 uppercase tracking-wider">Proveedor</th>
                ...
                >
                  <td className="py-3.5 px-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium text-slate-900 text-sm">{b.businessName}</span>
                    </div>
                  </td>
                  <td className="py-3.5 px-4">
                  ...
                  <td className="py-3.5 px-4 text-sm text-slate-500">{b.whatsappNumber || '—'}</td>
                  <td className="py-3.5 px-4">
                  ...
                  <td className="py-3.5 px-4">
                    <div className="flex items-center justify-end gap-1.5 opacity-60 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="p-2 rounded-lg text-amber-600 hover:text-amber-700 hover:bg-amber-100 transition-all"
                      >
 ...
 : 'text-emerald-600 hover:text-emerald-700 hover:bg-emerald-100'
                      ...
                      <button
                        ...
                        title="Panel Admin"
                        className="p-2 rounded-lg text-cyan-600 hover:text-cyan-700 hover:bg-cyan-100 transition-all"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        title="Ver Menú"
                        className="p-2 rounded-lg text-emerald-600 hover:text-emerald-700 hover:bg-emerald-100 transition-all"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        title="Eliminar"
                        className="p-2 rounded-lg text-red-600 hover:text-red-700 hover:bg-red-100 transition-all"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
