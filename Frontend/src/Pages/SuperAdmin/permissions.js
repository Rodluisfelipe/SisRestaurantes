...
export const NAV_BY_ROLE = {
  owner:   ['home', 'businesses', 'orders', 'banners', 'announcements', 'subscriptions', 'referrals', 'crew_people', 'crew_kyc', 'crew_employers', 'crew_finance', 'team', 'audit'],
  admin:   ['home', 'businesses', 'orders', 'banners', 'announcements', 'subscriptions', 'referrals', 'crew_people', 'crew_kyc', 'crew_employers', 'crew_finance', 'audit'],
  support: ['home', 'businesses', 'orders', 'banners', 'announcements', 'subscriptions', 'referrals', 'crew_people', 'crew_kyc', 'crew_employers', 'crew_finance', 'audit'],
  auditor: ['home', 'businesses', 'orders', 'banners', 'announcements', 'subscriptions', 'referrals', 'crew_people', 'crew_kyc', 'crew_employers', 'crew_finance', 'audit'],
};
