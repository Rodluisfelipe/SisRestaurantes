...
function AlertPill({ tone = 'amber', label, count, onClick }) {
  ...
  return (
    ...
    >
      <span className="inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-md bg-slate-100 text-[11px] font-bold tabular-nums">
        {count}
      </span>
      <span>{label}</span>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-cyan-500/[0.08] via-blue-500/[0.05] to-violet-500/[0.06] border border-slate-200 rounded-xl p-5 sm:p-6">
        ...
        <div className="relative flex items-start justify-between gap-4 flex-wrap">
          ...
          <button
            ...
            className="text-xs font-semibold text-slate-700 hover:text-slate-900 px-3.5 py-2 rounded-lg bg-slate-100 border border-slate-200 hover:bg-white transition-all flex items-center gap-1.5 backdrop-blur-sm"
          >
