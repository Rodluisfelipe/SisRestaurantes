        ...
        <div className="p-6 sm:p-10">
          ...
          >
            ...
            {googleLoading && (
              <div className="flex justify-center mt-3">
                <svg className="animate-spin h-5 w-5 text-[#A5B9FF]" fill="none" viewBox="0 0 24 24">
          ...
          <div className="relative mb-5">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-[#333F50]"></div>
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-[#333F50]/80 text-[#A5B9FF] rounded">o</span>
            </div>
          </div>
