            ...
            >
              ...
              <div className="relative mb-4">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-menuby-borde"></div>
                </div>
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-menuby-gris">o inicia con email</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input
                  type="checkbox"
                      className="w-4 h-4 text-menuby border-gray-300 rounded focus:ring-menuby"
                />
                    <span className="ml-2 text-sm text-gray-600">Recordarme</span>
                </label>
                  <Link
                    to="/forgot-password"
                    className="text-sm text-menuby hover:text-menuby-fuerte font-medium"
                  >
              ...
              <div className="mt-5 text-center">
                <p className="text-[14px] text-menuby-gris">
                  ...
                  <Link
                    to="/register"
                    className="text-menuby hover:text-menuby-fuerte font-semibold"
                  >
                    Regístrate gratis
              </Link>
            </p>
