...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", color: C.text, background: C.bg, overflowX: 'hidden' }}>
      ...
      <a
        href="https://wa.me/573138178003?text=Hola%2C%20me%20interesa%20Menuby%20para%20mi%20restaurante"
        target="_blank"
      ...
      >
        {/* Tooltip */}
        <span
          className="hidden sm:block px-3 py-1.5 rounded-xl text-[12px] font-semibold text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap"
