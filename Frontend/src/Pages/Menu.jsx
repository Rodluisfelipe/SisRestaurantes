...
// Lazy-loaded review components (separate chunks, zero framer-motion)
...
export default function Menu() {
  ...
  return (
    ...
    <main className="min-h-screen bg-gray-50 pb-20 pt-safe">
      ...
      {/* Reviews — lazy loaded, separate chunks */}
      <Suspense fallback={null}>
        {showReviewModal && (
          <ReviewModal
            show={showReviewModal}
            onClose={(submitted) => { setShowReviewModal(false); setPendingReviewOrder(null); }}
            businessId={businessId}
