...
export default function Menu() {
  ...
  useEffect(() => {
    logger.info('Menu - businessConfig:', {
      isOpen: businessConfig?.isOpen,
      isActive: businessConfig?.isActive,
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                Este negocio está cerrado en este momento. Los pedidos podrían no ser procesados hasta que el negocio abra nuevamente.
              </p>
            </div>
          </div>
        </div>
