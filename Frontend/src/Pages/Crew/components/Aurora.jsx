...
const VARIANTS = {
  default: {
    ...
    blobs: [
      ...
      { c: 'bg-red-600/20', size: 'w-[300px] h-[300px]', x: '20%', y: '70%', dx: ['20%', '35%', '20%'], dy: ['70%', '60%', '70%'], dur: 16 },
      { c: 'bg-white/[0.06]', size: 'w-[280px] h-[280px]', x: '75%', y: '75%', dx: ['75%', '65%', '75%'], dy: ['75%', '85%', '75%'], dur: 20 },
    ],
  },
  hero: {
    bg: 'bg-[#08080f]',
    blobs: [
      ...
      { c: 'bg-red-400/30', size: 'w-[480px] h-[480px]', x: '60%', y: '10%', dx: ['60%', '40%', '60%'], dy: ['10%', '30%', '10%'], dur: 24 },
      { c: 'bg-red-700/25', size: 'w-[400px] h-[400px]', x: '30%', y: '70%', dx: ['30%', '45%', '30%'], dy: ['70%', '55%', '70%'], dur: 20 },
    ],
  },
  light: {
    bg: 'bg-white',
    blobs: [
      ...
      { c: 'bg-red-300/25', size: 'w-[280px] h-[280px]', x: '70%', y: '60%', dx: ['70%', '60%', '70%'], dy: ['60%', '70%', '60%'], dur: 18 },
    ],
  },
};
        ...
        return (
          <motion.span
            ...
            style={{
              ...
              width: `${size}px`,
              height: `${size}px`,
              boxShadow: `0 0 ${4 + size * 2}px rgba(255,255,255,0.9), 0 0 ${8 + size * 3}px rgba(239,68,68,0.5)`,
            }}
