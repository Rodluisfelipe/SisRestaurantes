    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className={`fixed top-5 left-1/2 z-[70] flex items-center gap-2 px-4 py-2.5 rounded-lg border text-sm font-medium shadow-xl shadow-slate-900/10 ${styles[type]}`}
          onClick={onClose}
        >
