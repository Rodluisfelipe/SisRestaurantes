      ...
      {loading ? (
        ...
        <div className="grid sm:grid-cols-2 gap-2">
          {employers.map((e) => (
            ...
            >
              {e.photo ? (
                <img src={e.photo} alt="" className="w-12 h-12 rounded-lg object-cover border border-slate-200 shrink-0" />
              ) : (
          ...
          <div className="space-y-4">
            ...
            <div className="text-xs text-slate-500 space-y-0.5">
              ...
              {target.rejectionReason && (
                <p className="text-rose-600">Motivo del rechazo: {target.rejectionReason}</p>
              )}
