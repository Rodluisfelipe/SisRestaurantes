...
const TableValidator = ({ children }) => {
  ...
  const tLabel = isHotel ? 'habitación' : 'mesa';
  const tLabelCap = isHotel ? 'Habitación' : 'Mesa';
  ...
  if (isValidating) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        ...
        <p className="text-gray-700 text-lg">Validando {tLabel} {tableNumber}...</p>
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">{tLabelCap} no válida</h2>
          <p className="text-gray-600 mb-4">{error || `La ${tLabel} que intentas acceder no existe.`}</p>
          <p className="text-gray-500 mb-2">{tLabelCap}: {tableNumber}</p>
