...
const TAB_CONFIG = {
  ...
  'cajas':            { title: 'Punto de venta',          desc: 'Cajas, cierres, auditoría, devoluciones y ventas de la caja' },
  ...
  'rentabilidad':     { title: 'Rentabilidad',            desc: 'Ventas, costo, utilidad y margen de lo vendido' },
  'credito':          { title: 'Cuentas por cobrar',      desc: 'Crédito de los clientes: cupos, saldos y abonos' },
  'compras':          { title: 'Compras',                 desc: 'Proveedores, compras, por pagar y qué comprar' },
