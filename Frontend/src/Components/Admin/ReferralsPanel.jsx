...
export default function ReferralsPanel() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-xl font-bold text-slate-800">Programa de Referidos</h2>
        <p className="text-sm text-slate-500 mt-1">Invita otros negocios y gana créditos para tu suscripción</p>
      </div>

      {/* Quick Stats */}
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-white rounded-xl border border-slate-100 p-4 text-center shadow-sm">
          <p className="text-2xl font-bold text-slate-800">{stats.totalReferred || codeData?.referralCount || 0}</p>
          <p className="text-xs text-slate-400 mt-1">Referidos</p>
        </div>
        <div className="bg-white rounded-xl border border-slate-100 p-4 text-center shadow-sm">
          <p className="text-2xl font-bold text-emerald-600">{stats.totalCredited || 0}</p>
          <p className="text-xs text-slate-400 mt-1">Acreditados</p>
        </div>
        <div className="bg-white rounded-xl border border-slate-100 p-4 text-center shadow-sm">
          <p className="text-2xl font-bold text-blue-600">{formatCurrency(credits.credits || 0)}</p>
