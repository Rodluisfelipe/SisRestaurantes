...
const I = {
  ...
  popups:     <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 11l18-5v12L3 14v-3z"/><path d="M11.6 16.8a3 3 0 11-5.8-1.6"/></svg>,
  ...
  const sections = [
    {
      ...
      items: [
        ...
        { id: 'rentabilidad',     label: 'Rentabilidad',      icon: I.completed,  bg: 'bg-slate-700' },
        { id: 'credito',          label: 'Cuentas por cobrar', icon: I.completed, bg: 'bg-amber-600' },
        { id: 'compras',          label: 'Compras',           icon: I.completed,  bg: 'bg-sky-600' },
        ...
        { id: 'cajas', label: 'Punto de venta', icon: I.orders, bg: 'bg-slate-500' },
      ],
    },
    {
