    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16 sm:h-18">
            ...
            <button
              ...
              className="sm:hidden relative z-50 w-11 h-11 rounded-xl bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors duration-200 active:scale-95"
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="flex flex-col h-full justify-end pb-10 px-6">
              <motion.div
