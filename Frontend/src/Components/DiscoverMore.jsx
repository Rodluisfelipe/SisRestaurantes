          ...
          return (
            ...
            >
              ...
              <div className="relative h-24 bg-slate-100 flex items-center justify-center overflow-hidden">
                ...
                {open !== null && (
                  <span
                    className={`absolute top-2 left-2 text-2xs font-bold px-1.5 py-0.5 rounded-full ${
                ...
                {cercanos && b.distanceKm != null && (
                  <span className="absolute top-2 right-2 text-2xs font-bold px-1.5 py-0.5 rounded-full bg-white/90 text-slate-600">
                ...
                <div className="flex items-center gap-1 mt-0.5 h-4">
                  {b.rating > 0 ? (
                    <>
                      ...
                      {b.reviewCount > 0 && <span className="text-2xs text-slate-400">({b.reviewCount})</span>}
                    </>
                  ) : (
                    <span className="text-2xs text-slate-300">Nuevo en MenuBy</span>
                  )}
                </div>
              </div>
            </a>
