...
/* ===============================================================
   REAL PHONE MOCKUP — Embeds the actual live menu via iframe
   =============================================================== */
...
const MARQUEE = [
  'Burger Joint {burger_e}', 'Sushi Express {chicken_e}', 'Pizza Place {drink_e}', 'La Taqueria {cake_e}',
  'El Corral {burger_e}', 'Crepes & Waffles {cake_e}', 'Frisby {chicken_e}', 'Presto {burger_e}',
  'Archies {burger_e}', 'Sandwich Cubano {burger_e}', 'Creppes {cake_e}', 'Wok {chicken_e}',
];
...
# Write to file
target = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Frontend', 'src', 'Pages', 'Landing', 'Home.jsx')
