...
const portafolioSchema = new mongoose.Schema({
   ...
   * propia vitrina no tendría sentido.
   *
  ...
  banners: [{
    ...
    /* A dónde lleva. Puede ser uno de sus negocios (`/doggitos`), o algo de
       afuera. Vacío = el banner se ve pero no es clicable, que es lo que
       hace falta cuando solo anuncia algo. */
