...
- "preguntaHorario": true si pregunta si están abiertos, si tienen servicio, hasta qué hora atienden o a qué hora abren. "¿tienen servicio?" → true. "¿hasta qué hora?" → true. "¿están abiertos?" → true.
