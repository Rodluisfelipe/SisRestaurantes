...
const ALLOWED_ORIGINS = process.env.ALLOWED_ORIGINS
  ...
  : ['http://menuby.tech', 'https://menuby.tech', 'https://www.menuby.tech', 'http://127.0.0.1:5173', 'http://localhost:5173', 'https://157-245-125-216.nip.io', 'https://159-203-136-199.nip.io', 'https://api.menuby.tech'];
...
app.use("/api/tracked-links", require("./Routes/trackedLinks")); // Enlaces marcados y ventas por origen
app.use("/api/spotify", require("./Routes/spotify")); // Banner de "que suena" en el menu
...
app.use("/api/stats", require("./Routes/publicStats")); // Métricas agregadas públicas (landing)
...
app.use("/api/places", require("./Routes/places")); // Google Places: autocompletado + vincular negocio
...
app.use("/api/whatsapp-campaign", require("./Routes/whatsappCampaign")); // Campañas WhatsApp por restaurante
